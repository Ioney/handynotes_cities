...
map.nodes[44237720] = ns.node.Blacksmithing({id = 37072})
map.nodes[76353709] = ns.node.Blacksmithing({id = 7231})
map.nodes[75913709] = ns.node.Blacksmithing({id = 7230})
map.nodes[76513451] = ns.node.Blacksmithing({id = 3555})
map.nodes[75873360] = ns.node.Blacksmithing({id = 11178})
map.nodes[75353399] = ns.node.Blacksmithing({id = 11177})
map.nodes[44567862] = ns.node.Mining({id = 46357})
map.nodes[72313491] = ns.node.Mining({id = 3357})
map.nodes[72473430] = ns.node.Jewelcrafting({id = 46675})
map.nodes[66454193] = ns.node.Fishing({id = 3332})
map.nodes[53494956] = ns.node.Enchanting({id = 3345})
map.nodes[55035050] = ns.node.Herbalism({id = 46741})
map.nodes[55075588] = ns.node.Inscription({id = 46716})
map.nodes[56845656] = ns.node.Engineering({id = 11017})
map.nodes[60895490] = ns.node.Leatherworking({id = 3365})
map.nodes[61155465] = ns.node.Skinning({id = 7088})
map.nodes[60755912] = ns.node.Tailoring({id = 3363})
map.nodes[56146162] = ns.node.Cooking({id = 46709})
map.nodes[41177939] = ns.node.Cooking({id = 133261})
map.nodes[40468031] = ns.node.Herbalism({id = 133104})
map.nodes[39058552] = ns.node.Mining({id = 133236})
map.nodes[38308714] = ns.node.Tailoring({id = 133239})
map.nodes[37098473] = ns.node.Engineering({id = 45545})
map.nodes[35566953] = ns.node.Inscription({id = 30706})
map.nodes[35176734] = ns.node.Fishing({id = 44975})
map.nodes[32256967] = ns.node.Cooking({id = 3399})
map.nodes[34836284] = ns.node.Herbalism({id = 3404})
map.nodes[40575024] = ns.node.Blacksmithing({id = 44781})
map.nodes[39394971] = ns.node.Skinning({id = 44782})
map.nodes[38845060] = ns.node.Tailoring({id = 44783})
map.nodes[55694574] = ns.node.Alchemy({id = 3347})
map.nodes[49077054] = ns.node.Archaeology({id = 47571})
map.nodes[38508640] = ns.node.FirstAid({id = 133109})
